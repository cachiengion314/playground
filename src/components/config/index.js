...
export const TYPE_OBSTACLE = "obstacle"
export const TYPE_CHESS_BLOCK = "chess-block"
export const TYPE_DESTINATION = "destination"

export const themes = [{
    "chessboard-bg-color": "#9370d8",

    "destinattion-color": `#9dff3a`,
...
},
{
    ...
    "obstacles-color": "greenyellow",
    "piece-highlight-color": "#ffdd94",
    "piece-hover-color": "#f1c692",
},
{
